...
CAPACITANCE = config.getfloat('Power', 'capacitance') # емкость бака
...
import pygame
pygame.init()
hugeFont   = pygame.font.SysFont("Courier New", 80, True)
BigFont   = pygame.font.SysFont("Courier New", 60, True)
