 ...
 *
 */
void ds1338_tm2bcd(struct tm *timp, uint8_t *bcd){
 ...
 *
 */
void ds1338_bcd2tm(uint8_t *bcd, struct tm *timp){
 ...
 *
 */
void ds1338_bcd2str(uint8_t *bcd, uint8_t *str){
  //"YY-MM-DD HH:MM:SS",
  *(str++) = '\n';
  *(str++) = (bcd[6] >> 4) + '0';
  *(str++) = (bcd[6] & 15) + '0';
 ...
 */
void ds1338_set_time(uint8_t *bcd){
  txbuf[0] = 0;
 ...
 */
void ds1338_get_time(uint8_t *bcd){
  txbuf[0] = 0;
 ...
 *
 */
static WORKING_AREA(DS1138ThreadWA, 512);
