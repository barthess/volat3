...
extern mavlink_oblique_storage_request_dm_t mavlink_oblique_storage_request_dm_struct;
extern mavlink_oblique_storage_request_count_dm_t mavlink_oblique_storage_request_count_dm_struct;
extern mavlink_heartbeat_dm_t mavlink_heartbeat_dm_struct;
  ...
  while (!chThdShouldTerminate()) {
    ...
    if (mavlink_parse_char(MAVLINK_COMM_0, (uint8_t)c, &msg, &status)) {
      switch(msg.msgid){
        ...
        case MAVLINK_MSG_ID_OBLIQUE_STORAGE_REQUEST_DM:
          mavlink_msg_oblique_storage_request_dm_decode(&msg, &mavlink_oblique_storage_request_dm_struct);
          if (mavlink_oblique_storage_request_dm_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_oblique_storage_request_dm, EVMSK_MAVLINK_OBLIQUE_STORAGE_REQUEST_DM);
          break;

        case MAVLINK_MSG_ID_OBLIQUE_STORAGE_REQUEST_COUNT_DM:
          mavlink_msg_oblique_storage_request_count_dm_decode(&msg, &mavlink_oblique_storage_request_count_dm_struct);
          if (mavlink_oblique_storage_request_count_dm_struct.target_system == mavlink_system_struct.sysid)
            chEvtBroadcastFlags(&event_mavlink_oblique_storage_request_count_dm, EVMSK_MAVLINK_OBLIQUE_STORAGE_REQUEST_COUNT_DM);
          break;

        case MAVLINK_MSG_ID_HEARTBEAT_DM:
          mavlink_msg_heartbeat_dm_decode(&msg, &mavlink_heartbeat_dm_struct);
//          if (mavlink_heartbeat_dm_struct.target_system == mavlink_system_struct.sysid)
