...
void boardInit(void) {
  ...
  /* tune reset pins as open collector */
  AT91C_BASE_PIOA->PIO_MDER  = PIOA_GSM_RESET_MASK;
  AT91C_BASE_PIOA->PIO_PPUDR = PIOA_GSM_RESET_MASK;
  AT91C_BASE_PIOA->PIO_MDER  = PIOA_GPS_RESET_MASK;
  AT91C_BASE_PIOA->PIO_PPUDR = PIOA_GPS_RESET_MASK;

  /*
   * RTS/CTS pins enabled for GSM USART only.
   */
//  AT91C_BASE_PIOB->PIO_PDR   = AT91C_PB24_RTS1  | AT91C_PB25_CTS1;
//  AT91C_BASE_PIOB->PIO_BSR   = AT91C_PIO_PB24   | AT91C_PIO_PB25;
//  AT91C_BASE_PIOB->PIO_PPUDR = AT91C_PIO_PB24   | AT91C_PIO_PB25;
//
  AT91C_BASE_PIOB->PIO_PDR   = AT91C_PB25_CTS1;
  AT91C_BASE_PIOB->PIO_BSR   = AT91C_PIO_PB25;
  AT91C_BASE_PIOB->PIO_PPUDR = AT91C_PIO_PB24   | AT91C_PIO_PB25;
