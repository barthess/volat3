...
// TODO: надо как-то обрабатывать убегание времени RTC вперед, потому что при коррекции временем, захваченным со спутников полчится точка перегиба в хранилище
...
// TODO: консольная апплут для работы с хранилищем (очистка, формат, статистика)
