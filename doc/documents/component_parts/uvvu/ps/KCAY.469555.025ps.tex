...
\newcommand{\nameDeviceAbbr}{\nameReplicator}
\newcommand{\nameDeviceFull}{\nameReplicator}
\newcommand{\ksauDevice}{\ksauReplicator}


% названия устройства в падежах, отличных от именителного
\newcommand{\genitivecasename}{репликатора} 		% родительном падеже
\newcommand{\prepositionalcasename}{репликаторе} 	% предложный падеж
